...
- **Status:** Accepted
- **Application Document:** [Kuma wallet](https://github.com/w3f/Grants-Program/blob/master/applications/cross-chain-wallet.md) 
- **Milestone:** 4
...
|--------|----------------------|------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|
| 0a.    | Licence              | <ul><li>[x] </li></ul> | [MIT](https://github.com/blockcoders/kuma-wallet/blob/main/LICENSE)                                                                                          | Correct Licence                                 |
| 0b.    | Documentation        | <ul><li>[x] </li></ul> | [ReadMe-EN](https://github.com/kumawallet/extension/blob/main/README.md),<br/>[ReadMe-ES](https://github.com/blockcoders/kuma-wallet/blob/main/README-es.md) | Well-written and well-structured docs           |
| 0c.    | Testing Guide        | <ul><li>[x] </li></ul> | [running-tests](https://github.com/kumawallet/extension#running-tests)                                                                                       | All test cases passed. Output attached below.   |
| 0d.    | Article              | <ul><li>[x] </li></ul> | [Twitter Thread](https://twitter.com/blockcoders_/status/1690077065087754240)                                                                                | The thread could have been more detailed.       |
| 1.     | Polish UX Experience | <ul><li>[x] </li></ul> | [PR M4](https://github.com/kumawallet/extension/pull/30)                                                                                                     | Working as per application                      |
| 2.     | Landing page         | <ul><li>[x] </li></ul> | https://kumawallet.io/                                                                                                                                       | Nice looking landing page and well-written docs |
| 3.     | Video tutorial       | <ul><li>[x] </li></ul> | [Tutorials](https://kumawallet.io/tutorials)                                                                                                                 | Nicely explained videos                         |
| 4.     | E2E testing          | <ul><li>[x] </li></ul> | [Tutorials](https://kumawallet.io/tutorials)                                                                                                                 | Working as per application                      |
| 5.     | QR Code              | <ul><li>[x] </li></ul> | [Receive.tsx](https://github.com/kumawallet/extension/blob/main/src/pages/receive/Receive.tsx)                                                               | Working as per application                      |


## General Notes

The milestone repository is well-structured and well-documented. No major issues were found during unit testing or integration testing of the milestone. 

### `npm test` output
```commandline
npm test 

> kuma-wallet@0.3.5 test
> vitest --reporter=verbose


 DEV  v0.34.1 /home/rustacean/Desktop/Workspace/web3/extension
 ...
 ✓ src/storage/entities/registry/Registry.test.ts (21)
   ✓ Registry (21)
     ...
     ✓ get recent
     ✓ get all contacts
 ✓ src/pages/send/components/WasmForm.test.tsx (3) 3253ms
   ✓ WasmForm (3) 3252ms
     ✓ should call confirmTx 1091ms
     ✓ should call confirmTx with created asset 1091ms
     ✓ should call confirmTx with xcm 1069ms
 ...
 ✓ src/providers/accountProvider/AccountProvider.test.tsx (9) 374ms
   ✓ AccountProvider (9) 373ms
     ✓ reducer (2)
       ✓ should set accounts
 ...
 ✓ src/pages/accountForm/AccountForm.test.tsx (5) 632ms
   ✓ AccountForm (5) 631ms
     ✓ import account (1)
       ✓ should render
     ✓ create account (2)
     ...
     ✓ derive account (1)
       ✓ should render
 ✓ src/pages/signMessage/SignMessage.test.tsx (2) 479ms
   ✓ SignMessage (2) 478ms
     ✓ should sign evm message 366ms
 ...
 ✓ src/storage/entities/settings/Settings.test.ts (13)
   ✓ Settings (13)
     ...
     ✓ update
     ✓ allready exists
 ✓ src/pages/manageAssets/ManageAssets.test.tsx (3) 632ms
   ✓ ManageAssets (3) 632ms
     ✓ should render evm
     ✓ should fill the form and submit 315ms
 ...
 ✓ src/pages/send/components/Destination.test.tsx (2) 376ms
   ✓ Destination (2) 376ms
     ✓ should render options
     ✓ should filter
 ✓ src/pages/balance/components/ChainSelector.test.tsx (2) 816ms
   ✓ ChainSelector (2) 814ms
     ✓ should render 472ms
     ✓ should change account
 ✓ src/pages/balance/components/AccountList.test.tsx (1) 470ms
   ✓ AccountList (1) 469ms
     ✓ should render accounts 448ms
 ✓ src/storage/entities/BaseEntity.test.ts (7)
   ✓ BaseEntity (7)
     ...
     ✓ set
     ✓ remove
 ✓ src/pages/send/components/ConfirmTx.test.tsx (2) 433ms
   ✓ ConfirmTx (2) 430ms
     ✓ should render correctly
     ✓ should call onConfirm when confirm button is clicked
 ✓ src/storage/entities/keyrings/hd/EVMKeyring.test.ts (8) 1565ms
   ✓ EVMKeyring (8) 1564ms
     ✓ should return next account path
     ✓ should return address 931ms
     ✓ get key (2)
       ✓ should return key
 ...
 ✓ src/pages/settings/Contacts.test.tsx (3) 500ms
   ✓ Contacts (3) 500ms
     ✓ should render 357ms
     ✓ should show no contacts
     ✓ should create contact
 ✓ src/pages/balance/components/Activity.test.tsx (2) 337ms
   ✓ Actvity (2) 330ms
     ✓ should render
     ✓ should filter by network
 ✓ src/pages/send/components/SelectableAsset.test.tsx (3) 306ms
   ✓ SelectableAsset (3) 305ms
     ✓ should render
     ✓ should render all assets
     ✓ should call change asset
 ✓ src/pages/settings/General.test.tsx (3) 330ms
   ✓ General (3) 326ms
     ✓ should render
 ...
 Test Files  61 passed (61)
   ...
   Start at  10:50:26
   Duration  74.85s (transform 5.55s, setup 38.78s, collect 122.99s, tests 14.35s, environment 64.49s, prepare 19.55s)


 PASS  Waiting for file changes...
       press h to show help, press q to quit
 Manifest file copy complete: /home/rustacean/Desktop/Workspace/web3/extension/public/manifest.json
 contentStyle copied
