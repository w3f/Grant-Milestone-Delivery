...
2. Implementation of an RPC Wrapper API that allows for querying on-chain data, such as block info, validators, etc.
...
6. Start Agent: `pnpm start`
7. (Optional) set .env with **POLKADOT_PRIVATE_KEY**
