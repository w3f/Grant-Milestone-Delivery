...
| 0b.    | Documentation            | [Link](https://bytepay.online/docs/bytepay-overview https://bytepay.online/docs/bytepay-userguide) | Dotpay user guide, workflow, and what is dotpay.                                  |
