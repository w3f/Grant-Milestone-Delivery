...
| 3.     | 	Address binding               | [Link](https://github.com/Evanesco-Labs/substrate.git)  | Develop using github issue comment to bind their polkadot address. /dotpay bind [address] |
...
| 5.     | Transfer ink! contract      |  [Link](https://github.com/Evanesco-Labs/substrate/blob/master/tutorial.md#4-whitenoise-testnet)| We will provide an tested ink! contract on Substrate Smart Contracts Node, provide transfer limit, whitelist and transfer function. The platform will integrate the contract when the Polkadot mainnet contract para chain is available.                                  |
