...
| **0d.** | Docker |https://github.com/antiers-solutions/polkadot-staking-miner/blob/main/Dockerfile.README.md | Dockerfile to build and run the CLI simulator locally. |
