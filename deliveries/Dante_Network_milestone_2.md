...
| 0e. | Article | [link](https://dantenetwork.medium.com/the-first-version-of-dante-protocol-in-substrate-ink-tech-stack-granted-by-web3-foundation-2471c9c5d4bf) | We continue to publish articles on the [Medium of Dante](https://dantenetwork.medium.com/), and the `link` is related to a typical one. |
